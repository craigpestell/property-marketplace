...
CREATE ROLE craig;
ALTER ROLE craig WITH SUPERUSER INHERIT CREATEROLE CREATEDB LOGIN REPLICATION BYPASSRLS PASSWORD 'SCRAM-SHA-256$4096:ejqRKCghRCPbbsgBSHA9Kg==$5kf96OPgec4Ckz527RpgvkzC7lSDv/vZHUI09J2lFI8=:UUsrO+MzK+d10XYZ+a1DtysldxqlhPgJVSBQL54Bsxg=';
...
--
-- Name: mydb; Type: DATABASE; Schema: -; Owner: craig
--

CREATE DATABASE mydb WITH TEMPLATE = template0 ENCODING = 'UTF8' LOCALE = 'C';


ALTER DATABASE mydb OWNER TO craig;
...
--
-- Name: OrderStatusEnum; Type: TYPE; Schema: public; Owner: craig
--
...
ALTER TYPE public."OrderStatusEnum" OWNER TO craig;

--
-- Name: PaymentStatusEnum; Type: TYPE; Schema: public; Owner: craig
--
...
ALTER TYPE public."PaymentStatusEnum" OWNER TO craig;
...
--
-- Name: Address; Type: TABLE; Schema: public; Owner: craig
--

CREATE TABLE public."Address" (
    id text NOT NULL,
    country text DEFAULT 'IRI'::text NOT NULL,
...
ALTER TABLE public."Address" OWNER TO craig;

--
-- Name: Author; Type: TABLE; Schema: public; Owner: craig
--
...
ALTER TABLE public."Author" OWNER TO craig;

--
-- Name: Banner; Type: TABLE; Schema: public; Owner: craig
--
...
ALTER TABLE public."Banner" OWNER TO craig;

--
-- Name: Blog; Type: TABLE; Schema: public; Owner: craig
--
...
ALTER TABLE public."Blog" OWNER TO craig;

--
-- Name: Brand; Type: TABLE; Schema: public; Owner: craig
--
...
ALTER TABLE public."Brand" OWNER TO craig;

--
-- Name: Cart; Type: TABLE; Schema: public; Owner: craig
--
...
ALTER TABLE public."Cart" OWNER TO craig;

--
-- Name: CartItem; Type: TABLE; Schema: public; Owner: craig
--
...
ALTER TABLE public."CartItem" OWNER TO craig;

--
-- Name: Category; Type: TABLE; Schema: public; Owner: craig
--
...
ALTER TABLE public."Category" OWNER TO craig;

--
-- Name: DiscountCode; Type: TABLE; Schema: public; Owner: craig
--
...
ALTER TABLE public."DiscountCode" OWNER TO craig;

--
-- Name: Error; Type: TABLE; Schema: public; Owner: craig
--
...
ALTER TABLE public."Error" OWNER TO craig;

--
-- Name: File; Type: TABLE; Schema: public; Owner: craig
--
...
ALTER TABLE public."File" OWNER TO craig;

--
-- Name: Notification; Type: TABLE; Schema: public; Owner: craig
--
...
ALTER TABLE public."Notification" OWNER TO craig;

--
-- Name: Order; Type: TABLE; Schema: public; Owner: craig
--
...
ALTER TABLE public."Order" OWNER TO craig;

--
-- Name: OrderItem; Type: TABLE; Schema: public; Owner: craig
--
...
ALTER TABLE public."OrderItem" OWNER TO craig;

--
-- Name: Order_number_seq; Type: SEQUENCE; Schema: public; Owner: craig
--
...
ALTER TABLE public."Order_number_seq" OWNER TO craig;

--
-- Name: Order_number_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: craig
--
...
--
-- Name: Owner; Type: TABLE; Schema: public; Owner: craig
--
...
ALTER TABLE public."Owner" OWNER TO craig;

--
-- Name: Payment; Type: TABLE; Schema: public; Owner: craig
--
...
ALTER TABLE public."Payment" OWNER TO craig;

--
-- Name: PaymentProvider; Type: TABLE; Schema: public; Owner: craig
--
...
ALTER TABLE public."PaymentProvider" OWNER TO craig;

--
-- Name: Payment_number_seq; Type: SEQUENCE; Schema: public; Owner: craig
--
...
ALTER TABLE public."Payment_number_seq" OWNER TO craig;

--
-- Name: Payment_number_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: craig
--

ALTER SEQUENCE public."Payment_number_seq" OWNED BY public."Payment".number;


--
-- Name: Product; Type: TABLE; Schema: public; Owner: craig
--
...
ALTER TABLE public."Product" OWNER TO craig;

--
-- Name: ProductReview; Type: TABLE; Schema: public; Owner: craig
--
...
ALTER TABLE public."ProductReview" OWNER TO craig;

--
-- Name: Refund; Type: TABLE; Schema: public; Owner: craig
--
...
ALTER TABLE public."Refund" OWNER TO craig;

--
-- Name: User; Type: TABLE; Schema: public; Owner: craig
--
...
ALTER TABLE public."User" OWNER TO craig;

--
-- Name: _BannerToCategory; Type: TABLE; Schema: public; Owner: craig
--
...
ALTER TABLE public."_BannerToCategory" OWNER TO craig;

--
-- Name: _CategoryToProduct; Type: TABLE; Schema: public; Owner: craig
--
...
ALTER TABLE public."_CategoryToProduct" OWNER TO craig;

--
-- Name: _Wishlist; Type: TABLE; Schema: public; Owner: craig
--
...
ALTER TABLE public."_Wishlist" OWNER TO craig;

--
-- Name: Order number; Type: DEFAULT; Schema: public; Owner: craig
--
...
--
-- Name: Payment number; Type: DEFAULT; Schema: public; Owner: craig
--

ALTER TABLE ONLY public."Payment" ALTER COLUMN number SET DEFAULT nextval('public."Payment_number_seq"'::regclass);


--
-- Data for Name: Address; Type: TABLE DATA; Schema: public; Owner: craig
--

COPY public."Address" (id, country, address, city, phone, "postalCode", "userId", "createdAt") FROM stdin;
\.


--
-- Data for Name: Author; Type: TABLE DATA; Schema: public; Owner: craig
--

COPY public."Author" (id, email, phone, name, avatar, "OTP", "createdAt", "updatedAt") FROM stdin;
\.


--
-- Data for Name: Banner; Type: TABLE DATA; Schema: public; Owner: craig
--

COPY public."Banner" (id, label, image, "createdAt", "updatedAt") FROM stdin;
\.


--
-- Data for Name: Blog; Type: TABLE DATA; Schema: public; Owner: craig
--

COPY public."Blog" (slug, title, image, description, content, categories, keywords, "authorId", "createdAt", "updatedAt") FROM stdin;
\.


--
-- Data for Name: Brand; Type: TABLE DATA; Schema: public; Owner: craig
--

COPY public."Brand" (id, title, description, logo) FROM stdin;
\.


--
-- Data for Name: Cart; Type: TABLE DATA; Schema: public; Owner: craig
--

COPY public."Cart" ("userId", "createdAt", "updatedAt") FROM stdin;
\.


--
-- Data for Name: CartItem; Type: TABLE DATA; Schema: public; Owner: craig
--

COPY public."CartItem" ("cartId", "productId", count) FROM stdin;
\.


--
-- Data for Name: Category; Type: TABLE DATA; Schema: public; Owner: craig
--

COPY public."Category" (id, title, description, "createdAt", "updatedAt") FROM stdin;
\.


--
-- Data for Name: DiscountCode; Type: TABLE DATA; Schema: public; Owner: craig
--

COPY public."DiscountCode" (id, code, stock, description, percent, "maxDiscountAmount", "startDate", "endDate", "createdAt") FROM stdin;
\.


--
-- Data for Name: Error; Type: TABLE DATA; Schema: public; Owner: craig
--

COPY public."Error" (id, error, "userId", "createdAt") FROM stdin;
\.


--
-- Data for Name: File; Type: TABLE DATA; Schema: public; Owner: craig
--

COPY public."File" (id, url, "userId", "createdAt") FROM stdin;
\.


--
-- Data for Name: Notification; Type: TABLE DATA; Schema: public; Owner: craig
--

COPY public."Notification" (id, content, "isRead", "userId", "createdAt", "updatedAt") FROM stdin;
\.


--
-- Data for Name: Order; Type: TABLE DATA; Schema: public; Owner: craig
--

COPY public."Order" (id, number, status, total, shipping, payable, tax, discount, "isPaid", "isCompleted", "discountCodeId", "addressId", "userId", "createdAt", "updatedAt") FROM stdin;
\.


--
-- Data for Name: OrderItem; Type: TABLE DATA; Schema: public; Owner: craig
--

COPY public."OrderItem" ("orderId", "productId", count, price, discount) FROM stdin;
\.


--
-- Data for Name: Owner; Type: TABLE DATA; Schema: public; Owner: craig
--

COPY public."Owner" (id, email, phone, name, avatar, "OTP", "createdAt", "updatedAt") FROM stdin;
\.


--
-- Data for Name: Payment; Type: TABLE DATA; Schema: public; Owner: craig
--

COPY public."Payment" (id, number, status, "refId", "cardPan", "cardHash", fee, "isSuccessful", payable, "providerId", "userId", "orderId", "createdAt", "updatedAt") FROM stdin;
\.


--
-- Data for Name: PaymentProvider; Type: TABLE DATA; Schema: public; Owner: craig
--

COPY public."PaymentProvider" (id, title, description, "websiteUrl", "isActive") FROM stdin;
\.


--
-- Data for Name: Product; Type: TABLE DATA; Schema: public; Owner: craig
--

COPY public."Product" (id, title, description, images, keywords, metadata, price, discount, stock, "isPhysical", "isAvailable", "isFeatured", "brandId", "createdAt", "updatedAt") FROM stdin;
\.


--
-- Data for Name: ProductReview; Type: TABLE DATA; Schema: public; Owner: craig
--

COPY public."ProductReview" (id, text, rating, "productId", "userId", "createdAt", "updatedAt") FROM stdin;
\.


--
-- Data for Name: Refund; Type: TABLE DATA; Schema: public; Owner: craig
--

COPY public."Refund" (id, amount, reason, "orderId", "createdAt", "updatedAt") FROM stdin;
\.


--
-- Data for Name: User; Type: TABLE DATA; Schema: public; Owner: craig
--

COPY public."User" (id, email, phone, name, birthday, "OTP", "emailUnsubscribeToken", "referralCode", "isBanned", "isEmailVerified", "isPhoneVerified", "isEmailSubscribed", "isPhoneSubscribed", "createdAt", "updatedAt") FROM stdin;
cmc8g660a0000ueb2yuj7kkg5	craigpestell@gmail.com	\N	\N	\N	26161	\N	\N	f	t	t	f	f	1970-01-01 00:00:00	2025-06-23 02:36:46.316
\.


--
-- Data for Name: _BannerToCategory; Type: TABLE DATA; Schema: public; Owner: craig
--

COPY public."_BannerToCategory" ("A", "B") FROM stdin;
\.


--
-- Data for Name: _CategoryToProduct; Type: TABLE DATA; Schema: public; Owner: craig
--
...
--
-- Data for Name: _Wishlist; Type: TABLE DATA; Schema: public; Owner: craig
--

COPY public."_Wishlist" ("A", "B") FROM stdin;
\.


--
-- Name: Order_number_seq; Type: SEQUENCE SET; Schema: public; Owner: craig
--
...
--
-- Name: Payment_number_seq; Type: SEQUENCE SET; Schema: public; Owner: craig
--

SELECT pg_catalog.setval('public."Payment_number_seq"', 1, false);


--
-- Name: Address Address_pkey; Type: CONSTRAINT; Schema: public; Owner: craig
--
...
--
-- Name: Author Author_pkey; Type: CONSTRAINT; Schema: public; Owner: craig
--
...
--
-- Name: Banner Banner_pkey; Type: CONSTRAINT; Schema: public; Owner: craig
--
...
--
-- Name: Blog Blog_pkey; Type: CONSTRAINT; Schema: public; Owner: craig
--
...
--
-- Name: Brand Brand_pkey; Type: CONSTRAINT; Schema: public; Owner: craig
--
...
--
-- Name: Cart Cart_pkey; Type: CONSTRAINT; Schema: public; Owner: craig
--
...
--
-- Name: Category Category_pkey; Type: CONSTRAINT; Schema: public; Owner: craig
--
...
--
-- Name: DiscountCode DiscountCode_pkey; Type: CONSTRAINT; Schema: public; Owner: craig
--
...
--
-- Name: Error Error_pkey; Type: CONSTRAINT; Schema: public; Owner: craig
--
...
--
-- Name: File File_pkey; Type: CONSTRAINT; Schema: public; Owner: craig
--
...
--
-- Name: Notification Notification_pkey; Type: CONSTRAINT; Schema: public; Owner: craig
--
...
--
-- Name: Order Order_pkey; Type: CONSTRAINT; Schema: public; Owner: craig
--
...
--
-- Name: Owner Owner_pkey; Type: CONSTRAINT; Schema: public; Owner: craig
--
...
--
-- Name: PaymentProvider PaymentProvider_pkey; Type: CONSTRAINT; Schema: public; Owner: craig
--
...
--
-- Name: Payment Payment_pkey; Type: CONSTRAINT; Schema: public; Owner: craig
--
...
--
-- Name: ProductReview ProductReview_pkey; Type: CONSTRAINT; Schema: public; Owner: craig
--
...
--
-- Name: Product Product_pkey; Type: CONSTRAINT; Schema: public; Owner: craig
--
...
--
-- Name: Refund Refund_pkey; Type: CONSTRAINT; Schema: public; Owner: craig
--
...
--
-- Name: User User_pkey; Type: CONSTRAINT; Schema: public; Owner: craig
--
...
--
-- Name: _BannerToCategory _BannerToCategory_AB_pkey; Type: CONSTRAINT; Schema: public; Owner: craig
--

ALTER TABLE ONLY public."_BannerToCategory"
    ADD CONSTRAINT "_BannerToCategory_AB_pkey" PRIMARY KEY ("A", "B");


--
-- Name: _CategoryToProduct _CategoryToProduct_AB_pkey; Type: CONSTRAINT; Schema: public; Owner: craig
--
...
--
-- Name: _Wishlist _Wishlist_AB_pkey; Type: CONSTRAINT; Schema: public; Owner: craig
--

ALTER TABLE ONLY public."_Wishlist"
    ADD CONSTRAINT "_Wishlist_AB_pkey" PRIMARY KEY ("A", "B");


--
-- Name: Address_userId_idx; Type: INDEX; Schema: public; Owner: craig
--
...
--
-- Name: Author_email_key; Type: INDEX; Schema: public; Owner: craig
--
...
--
-- Name: Author_phone_key; Type: INDEX; Schema: public; Owner: craig
--

CREATE UNIQUE INDEX "Author_phone_key" ON public."Author" USING btree (phone);


--
-- Name: Blog_authorId_idx; Type: INDEX; Schema: public; Owner: craig
--
...
--
-- Name: Brand_title_key; Type: INDEX; Schema: public; Owner: craig
--

CREATE UNIQUE INDEX "Brand_title_key" ON public."Brand" USING btree (title);


--
-- Name: CartItem_cartId_productId_key; Type: INDEX; Schema: public; Owner: craig
--
...
--
-- Name: Category_title_key; Type: INDEX; Schema: public; Owner: craig
--
...
--
-- Name: DiscountCode_code_key; Type: INDEX; Schema: public; Owner: craig
--
...
--
-- Name: Error_userId_idx; Type: INDEX; Schema: public; Owner: craig
--

CREATE INDEX "Error_userId_idx" ON public."Error" USING btree ("userId");


--
-- Name: File_userId_idx; Type: INDEX; Schema: public; Owner: craig
--
...
--
-- Name: Notification_userId_idx; Type: INDEX; Schema: public; Owner: craig
--
...
--
-- Name: OrderItem_orderId_productId_key; Type: INDEX; Schema: public; Owner: craig
--
...
--
-- Name: Order_addressId_idx; Type: INDEX; Schema: public; Owner: craig
--
...
--
-- Name: Order_discountCodeId_idx; Type: INDEX; Schema: public; Owner: craig
--

CREATE INDEX "Order_discountCodeId_idx" ON public."Order" USING btree ("discountCodeId");


--
-- Name: Order_number_key; Type: INDEX; Schema: public; Owner: craig
--
...
--
-- Name: Order_userId_idx; Type: INDEX; Schema: public; Owner: craig
--
...
--
-- Name: Owner_email_key; Type: INDEX; Schema: public; Owner: craig
--
...
--
-- Name: Owner_phone_key; Type: INDEX; Schema: public; Owner: craig
--
...
--
-- Name: PaymentProvider_title_key; Type: INDEX; Schema: public; Owner: craig
--

CREATE UNIQUE INDEX "PaymentProvider_title_key" ON public."PaymentProvider" USING btree (title);


--
-- Name: Payment_number_key; Type: INDEX; Schema: public; Owner: craig
--
...
--
-- Name: Payment_orderId_idx; Type: INDEX; Schema: public; Owner: craig
--
...
--
-- Name: Payment_providerId_idx; Type: INDEX; Schema: public; Owner: craig
--
...
--
-- Name: Payment_refId_key; Type: INDEX; Schema: public; Owner: craig
--

CREATE UNIQUE INDEX "Payment_refId_key" ON public."Payment" USING btree ("refId");


--
-- Name: Payment_userId_idx; Type: INDEX; Schema: public; Owner: craig
--
...
--
-- Name: ProductReview_productId_idx; Type: INDEX; Schema: public; Owner: craig
--
...
--
-- Name: ProductReview_productId_userId_key; Type: INDEX; Schema: public; Owner: craig
--

CREATE UNIQUE INDEX "ProductReview_productId_userId_key" ON public."ProductReview" USING btree ("productId", "userId");


--
-- Name: ProductReview_userId_idx; Type: INDEX; Schema: public; Owner: craig
--
...
--
-- Name: Product_brandId_idx; Type: INDEX; Schema: public; Owner: craig
--
...
--
-- Name: Refund_orderId_idx; Type: INDEX; Schema: public; Owner: craig
--
...
--
-- Name: Refund_orderId_key; Type: INDEX; Schema: public; Owner: craig
--
...
--
-- Name: User_emailUnsubscribeToken_key; Type: INDEX; Schema: public; Owner: craig
--

CREATE UNIQUE INDEX "User_emailUnsubscribeToken_key" ON public."User" USING btree ("emailUnsubscribeToken");


--
-- Name: User_email_key; Type: INDEX; Schema: public; Owner: craig
--
...
--
-- Name: User_phone_key; Type: INDEX; Schema: public; Owner: craig
--
...
--
-- Name: User_referralCode_key; Type: INDEX; Schema: public; Owner: craig
--
...
--
-- Name: _BannerToCategory_B_index; Type: INDEX; Schema: public; Owner: craig
--

CREATE INDEX "_BannerToCategory_B_index" ON public."_BannerToCategory" USING btree ("B");


--
-- Name: _CategoryToProduct_B_index; Type: INDEX; Schema: public; Owner: craig
--
...
--
-- Name: _Wishlist_B_index; Type: INDEX; Schema: public; Owner: craig
--

CREATE INDEX "_Wishlist_B_index" ON public."_Wishlist" USING btree ("B");


--
-- Name: Address Address_userId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: craig
--
...
--
-- Name: Blog Blog_authorId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: craig
--

ALTER TABLE ONLY public."Blog"
    ADD CONSTRAINT "Blog_authorId_fkey" FOREIGN KEY ("authorId") REFERENCES public."Author"(id) ON UPDATE CASCADE ON DELETE RESTRICT;


--
-- Name: CartItem CartItem_cartId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: craig
--

ALTER TABLE ONLY public."CartItem"
    ADD CONSTRAINT "CartItem_cartId_fkey" FOREIGN KEY ("cartId") REFERENCES public."Cart"("userId") ON UPDATE CASCADE ON DELETE RESTRICT;


--
-- Name: CartItem CartItem_productId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: craig
--
...
--
-- Name: Cart Cart_userId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: craig
--
...
--
-- Name: Error Error_userId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: craig
--
...
--
-- Name: File File_userId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: craig
--
...
--
-- Name: Notification Notification_userId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: craig
--
...
--
-- Name: OrderItem OrderItem_orderId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: craig
--
...
--
-- Name: OrderItem OrderItem_productId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: craig
--
...
--
-- Name: Order Order_addressId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: craig
--
...
--
-- Name: Order Order_discountCodeId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: craig
--

ALTER TABLE ONLY public."Order"
    ADD CONSTRAINT "Order_discountCodeId_fkey" FOREIGN KEY ("discountCodeId") REFERENCES public."DiscountCode"(id) ON UPDATE CASCADE ON DELETE SET NULL;


--
-- Name: Order Order_userId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: craig
--
...
--
-- Name: Payment Payment_orderId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: craig
--
...
--
-- Name: Payment Payment_providerId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: craig
--

ALTER TABLE ONLY public."Payment"
    ADD CONSTRAINT "Payment_providerId_fkey" FOREIGN KEY ("providerId") REFERENCES public."PaymentProvider"(id) ON UPDATE CASCADE ON DELETE RESTRICT;


--
-- Name: Payment Payment_userId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: craig
--
...
--
-- Name: ProductReview ProductReview_productId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: craig
--
...
--
-- Name: ProductReview ProductReview_userId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: craig
--
...
--
-- Name: Product Product_brandId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: craig
--
...
--
-- Name: Refund Refund_orderId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: craig
--
...
--
-- Name: _BannerToCategory _BannerToCategory_A_fkey; Type: FK CONSTRAINT; Schema: public; Owner: craig
--

ALTER TABLE ONLY public."_BannerToCategory"
    ADD CONSTRAINT "_BannerToCategory_A_fkey" FOREIGN KEY ("A") REFERENCES public."Banner"(id) ON UPDATE CASCADE ON DELETE CASCADE;


--
-- Name: _BannerToCategory _BannerToCategory_B_fkey; Type: FK CONSTRAINT; Schema: public; Owner: craig
--

ALTER TABLE ONLY public."_BannerToCategory"
    ADD CONSTRAINT "_BannerToCategory_B_fkey" FOREIGN KEY ("B") REFERENCES public."Category"(id) ON UPDATE CASCADE ON DELETE CASCADE;


--
-- Name: _CategoryToProduct _CategoryToProduct_A_fkey; Type: FK CONSTRAINT; Schema: public; Owner: craig
--
...
--
-- Name: _CategoryToProduct _CategoryToProduct_B_fkey; Type: FK CONSTRAINT; Schema: public; Owner: craig
--
...
--
-- Name: _Wishlist _Wishlist_A_fkey; Type: FK CONSTRAINT; Schema: public; Owner: craig
--

ALTER TABLE ONLY public."_Wishlist"
    ADD CONSTRAINT "_Wishlist_A_fkey" FOREIGN KEY ("A") REFERENCES public."Product"(id) ON UPDATE CASCADE ON DELETE CASCADE;


--
-- Name: _Wishlist _Wishlist_B_fkey; Type: FK CONSTRAINT; Schema: public; Owner: craig
--

ALTER TABLE ONLY public."_Wishlist"
    ADD CONSTRAINT "_Wishlist_B_fkey" FOREIGN KEY ("B") REFERENCES public."User"(id) ON UPDATE CASCADE ON DELETE CASCADE;
...
--
-- Name: propmark; Type: DATABASE; Schema: -; Owner: craig
--

CREATE DATABASE propmark WITH TEMPLATE = template0 ENCODING = 'UTF8' LOCALE = 'C';


ALTER DATABASE propmark OWNER TO craig;
...
--
-- Database "real_estate_marketplace" dump
--
...
--
-- Name: real_estate_marketplace; Type: DATABASE; Schema: -; Owner: craig
--

CREATE DATABASE real_estate_marketplace WITH TEMPLATE = template0 ENCODING = 'UTF8' LOCALE = 'C';


ALTER DATABASE real_estate_marketplace OWNER TO craig;

\connect real_estate_marketplace
