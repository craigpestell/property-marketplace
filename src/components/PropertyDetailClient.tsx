                ...
                <div className='flex items-center text-gray-600 dark:text-gray-300 mb-4'>
                  ...
                  <span className='text-lg'>
                    {property.formatted_address ||
                      `${property.street_number || ''} ${property.street_name || ''}, ${property.city}, ${property.province}`.trim()}
                  </span>
                </div>
                    ...
                    <form className='space-y-4'>
                      ...
                      <div>
                        ...
                        <textarea
                          ...
                          defaultValue={`I'm interested in ${property.title} (${property.property_uid}) at ${property.formatted_address || `${property.street_number || ''} ${property.street_name || ''}, ${property.city}, ${property.province}`.trim()}. Please contact me with more information.`}
                        />
                      </div>
