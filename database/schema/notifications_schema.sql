...
CREATE TABLE IF NOT EXISTS user_notifications (
    ...
    related_offer_uid VARCHAR(50) REFERENCES offers(offer_uid) ON DELETE SET NULL,
...
CREATE OR REPLACE FUNCTION create_user_notification(
    ...
    p_related_offer_uid VARCHAR(50) DEFAULT NULL,
...
BEGIN
    INSERT INTO user_notifications (
        user_email, title, message, type, related_offer_id, related_offer_uid, related_property_uid, priority
    ) VALUES (
        p_user_email, p_title, p_message, p_type, p_related_offer_id, p_related_offer_uid, p_related_property_uid, p_priority
