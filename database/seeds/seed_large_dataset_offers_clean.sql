...
INSERT INTO offers (offer_uid, property_uid, buyer_email, seller_email, offer_amount, status, message, created_at, updated_at) VALUES
...
('OFFER-004-sf-loft', 'sf_loft_004', 'artist.emily@email.com', 'emily.davis@email.com', 1750000, 'countered', 'Perfect space for my art studio. Industrial character is amazing.', NOW() - INTERVAL '10 days', NOW() - INTERVAL '8 days'),
...
('OFFER-009-la-modern', 'la_house_014', 'hills.buyer@email.com', 'michelle.martin@email.com', 2350000, 'countered', 'Love the modern design and Hollywood Hills location.', NOW() - INTERVAL '22 days', NOW() - INTERVAL '20 days'),
...
('OFFER-014-ny-village', 'ny_apt_164', 'village.resident@email.com', 'jonathan.kim@email.com', 3400000, 'countered', 'Greenwich Village is my dream neighborhood. Historic charm is unmatched.', NOW() - INTERVAL '35 days', NOW() - INTERVAL '33 days'),
...
('OFFER-019-mia-key', 'mia_condo_204', 'key.resident@email.com', 'ana.lopez@email.com', 1900000, 'countered', 'Key Biscayne oceanfront living is exactly what we are looking for.', NOW() - INTERVAL '47 days', NOW() - INTERVAL '45 days'),
...
-- Chicago offers  
('OFFER-021-chi-lincoln', 'chi_apt_241', 'lincoln.family@email.com', 'thomas.kowalski@email.com', 1400000, 'pending', 'Victorian conversion in Lincoln Park is exactly what we have been searching for.', NOW() - INTERVAL '52 days', NOW() - INTERVAL '52 days'),
...
('OFFER-024-chi-gold', 'chi_condo_244', 'gold.exec@email.com', 'maria.kowalczyk@email.com', 2100000, 'countered', 'Gold Coast luxury with Lake Michigan views. Perfect for entertaining.', NOW() - INTERVAL '60 days', NOW() - INTERVAL '57 days'),
...
('OFFER-029-bos-south', 'bos_loft_284', 'south.end@email.com', 'sarah.murphy@email.com', 1800000, 'countered', 'South End warehouse conversion is exactly the modern space we need.', NOW() - INTERVAL '72 days', NOW() - INTERVAL '70 days'),
...
('OFFER-038-ny-uws', 'ny_apt_168', 'uws.family@email.com', 'dmitri.volkov@email.com', 2850000, 'countered', 'Upper West Side classic six near Central Park. Perfect for raising children.', NOW() - INTERVAL '115 days', NOW() - INTERVAL '110 days'),
...
('OFFER-043-chi-hyde', 'chi_house_248', 'hyde.professor@email.com', 'magdalena.nowak@email.com', 1600000, 'countered', 'Hyde Park historic mansion near University of Chicago. Academic dream home.', NOW() - INTERVAL '140 days', NOW() - INTERVAL '135 days'),
...
('OFFER-063-luxury1', 'ny_apt_176', 'meatpacking.luxury@email.com', 'alessandro.conti@email.com', 6500000, 'countered', 'Ultra-luxury penthouse in Meatpacking District. Ready for immediate occupancy.', NOW() - INTERVAL '320 days', NOW() - INTERVAL '315 days'),
...
('OFFER-067-recent2', 'bos_loft_284', 'south.end.couple@email.com', 'sarah.murphy@email.com', 1820000, 'countered', 'South End warehouse conversion perfect for our modern lifestyle.', NOW() - INTERVAL '4 days', NOW() - INTERVAL '2 days'),
...
('OFFER-070-recent5', 'sf_house_009', 'hayes.tech@email.com', 'ryan.anderson@email.com', 1520000, 'rejected', 'Hayes Valley modern with smart features perfect for tech professional.', NOW() - INTERVAL '9 days', NOW() - INTERVAL '6 days'),
...
('OFFER-072-intl2', 'mia_apt_201', 'brazil.buyer@email.com', 'carlos.santos@email.com', 3050000, 'countered', 'South Beach Art Deco for Brazilian family. Ocean Drive location perfect.', NOW() - INTERVAL '13 days', NOW() - INTERVAL '10 days'),
...
('OFFER-079-invest4', 'ny_apt_180', 'lic.developer@email.com', 'olaf.peterson@email.com', 1220000, 'countered', 'LIC waterfront for development company. Manhattan skyline views marketable.', NOW() - INTERVAL '31 days', NOW() - INTERVAL '28 days'),
